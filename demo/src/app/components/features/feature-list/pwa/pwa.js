        ...
        <section>
          ...
          <section>
            <div>
              ...
              <p>
                <span className="font-italic font-weight-bold">The web…but better</span>
                <br />
          ...
          <section>
            ...
            <p>
              <span className="font-weight-bold">Case 1 :</span>
              {' '}
Users nowadays doesn't want to install app every
            ...
            <p>
              <span className="font-weight-bold">Case 2 :</span>
              {' '}
In the world of millions apps and 30+ apps already on users phone with
            ...
            <p>
              <span className="font-weight-bold">Case 3 :</span>
              {' '}
Data bandwith, User who is on mobile with
          ...
          <section>
            ...
            <ul>
              <li>
                ...
                {' '}
(
                <abbr lang="en" title="Responsive Web Design">RWD</abbr>
), of course, to adapt interfaces to all screens;
              </li>
              <li>
                <span lang="en">Web Services</span>
                {' '}
and
                {' '}
                <span lang="en">Web Sockets</span>
                {' '}
provided by servers and which allow access to information or actions implementation via web actions;
              </li>
              <li>
Some
                <abbr lang="en" title="Application Programming Interface">API</abbr>
                {' '}
provided by browsers, which allow to take full advantage of the context (for example, we would have access to different APIs depending on the capabilities of the consulting hardware: audio, video, acceleration, geolocation, transcription, vibration, etc.).
              </li>
            </ul>
            ...
            <ul>
              <li>
                <span lang="en"><a href="https://developer.mozilla.org/fr/docs/Web/API/Service_Worker_API/Using_Service_Workers" target="_blank" rel="nofollow noopener">Service Workers</a></span>
&nbsp;: This is a browser capability to provide an intermediate layer between the Web App and the network, which runs in the background (even when the application is closed). This “network” layer is capable of listening and sending requests, notifications or even capturing connectivity changes;
              ...
              <li>
The
                <span lang="en"><a href="https://developer.mozilla.org/fr/docs/Utilisation_des_web_workers" target="_blank" rel="nofollow noopener">Web Workers</a></span>
                {' '}
are also background capabilities but they are rather dedicated to calculations and “services” oriented development.
              </li>
            </ul>
          </section>
          <hr />
