      ...
      <article>
        ...
        <section>
          <section>
            ...
            <p>
              <span className="font-weight-bold">Hot reloading</span>
              {' '}
only refreshes the files that were changed without losing the state of the app.
          ...
          <section>
            ...
            <p>
              ...
              {' '}
              <a href="https://webpack.github.io/docs/hot-module-replacement-with-webpack.html" target="_blank" rel="nofollow noopener">
