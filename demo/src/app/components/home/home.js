...
export default class Home extends Component {
  ...
  componentDidMount() {
    ...
    const doc = firebase.firestore().doc("/example/reactpwa");
    doc.set({
      name: "Yash Thakur"
    });
  }
...
And more importantly its
        ...
        <div className="container">
          ...
          <p className="text-center">
            Visit
            {' '}
            <a href="http://localhost:3003" rel="nofollow noopener" target="_blank">http://localhost:3003</a>
            {' '}
...
You might be interested to learn that current site is build using ReactPWA.
