            ...
            <div className="bg-dark row text-white p-4">
              <div className="float-left mr-4">
                ...
                <p className="mb-1">
                  ...
                  {' '}
                  <a className="text-white" href="https://opencollective.com/react-pwa" target="_blank" rel="nofollow noopener"><u>OpenCollective</u></a>
. Your small contribution motivates us and helps us moving forward, thus improving the project.
                </p>
                <p>
                  You can also visit our github repository:
                  {' '}
                  <a className="text-white" href="https://github.com/Atyantik/react-pwa" target="_blank" rel="nofollow noopener"><u>https://github.com/Atyantik/react-pwa</u></a>
                  {' '}
and star our repo.
                </p>
              </div>
